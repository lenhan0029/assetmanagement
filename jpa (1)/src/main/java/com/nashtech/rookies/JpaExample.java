...
public class JpaExample {
    ...
    public static void main(String[] args) {
        ...
        final EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory("Books");
        ...
        author.addBook(new Book("Book 1a"));
        author.addBook(new Book("Book 2a"));
